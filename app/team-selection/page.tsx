...
export default function TeamSelectionPage() {
  return (
    ...
    >
      ...
      <h1 className="font-display text-4xl md:text-6xl font-bold text-[var(--c-txt-0)] leading-tight">
        Team Selection<br />Simulator
      </h1>
      <RedRule centered delay={0.3} />
      <p className="mt-6 font-body text-[var(--c-txt-1)] max-w-md leading-relaxed mb-12">
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 font-body text-sm px-5 py-3 rounded-lg border border-[var(--c-border-md)] text-[var(--c-txt-0)] hover:border-[#dc2626] hover:text-[#ef4444] transition-all duration-200"
      >
        ← Back to GYMC
      </Link>
    </main>
